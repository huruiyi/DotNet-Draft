namespace BoilerplateApp.Services
{
    using Boilerplate.Web.Mvc;
    using BoilerplateApp.Constants;
    using System;
    ...
    public sealed class FeedService : IFeedService
    {
        ...
        public SyndicationFeed GetFeed(CancellationToken cancellationToken)
        {
            ...
            feed.Links.Add(SyndicationLink.CreateSelfLink(
                new Uri(this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetFeed)), ContentType.Atom));
            ...
            feed.Links.Add(SyndicationLink.CreateAlternateLink(
                new Uri(this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetIndex)), ContentType.Html));
        ...
        private List<SyndicationItem> GetItems(CancellationToken cancellationToken)
        {
            ...
            for (int i = 1; i < 4; ++i)
            {
                SyndicationItem item = new SyndicationItem()
                {
                    ...
                    Copyright = new TextSyndicationContent(string.Format("© {0} - {1}", DateTime.Now.Year, Application.Name)),
                };
                ...
                item.Links.Add(SyndicationLink.CreateMediaEnclosureLink(
                    new Uri(this.urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png")), ContentType.Png, 0));
