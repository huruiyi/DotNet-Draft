...
namespace VirtoCommerce.Platform.Data.Notifications
{
	...
	{
        /// <summary>
        /// Render notification content (body and subject)
        /// </summary>
        /// <param name="notification"></param>
		public void ResolveTemplate(Core.Notifications.Notification notification)
		{
            ///Get parameters that used in template
        ...
        /// <summary>
        /// Get notification properties that used as template parameters
        /// </summary>
        /// <param name="notification"></param>
        /// <returns></returns>
		public NotificationParameter[] ResolveNotificationParameters(Core.Notifications.Notification notification)
		{
            ...
            ///Check what properties has NotificationParameterAttribute
