...
(function ($) {
    ...
    function _36(_37, pp, _38) {
        ...
        _38 = _38 || {};
        pp.panel($.extend({}, _38, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_38.icon ? _38.icon : undefined), onLoad: function () {
                if (_38.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_8e) {
